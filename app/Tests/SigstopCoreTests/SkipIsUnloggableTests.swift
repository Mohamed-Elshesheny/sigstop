...
struct SkipIsUnloggableTests {
    ...
    struct CycleBookkeeping {
        ...
        mutating func execute(_ effect: Effect) {
            ...
            case .recordSkip:
                if currentCycle != nil { log.append("break_response.skipped") }

            case .recordIgnoredPrompt:
                if currentCycle != nil { log.append("break_response.ignored") }

            case .recordSnooze:
                if currentCycle != nil { log.append("break_response.snoozed") }
